...
**Time**: 2026-08-25T14:45:24.658636Z  
...
|---------|----|----|--------|
| preconditions | healthy_before_soak | cluster.health | ✓ |
| baseline | baseline_health | cluster.health | ✓ |
| baseline | baseline_services | services.count | ✓ |
| steps | sample_t0_health | cluster.health | ✓ |
| steps | sample_t0_services | services.count | ✓ |
| steps | sample_t90_health | cluster.health | ✓ |
| steps | sample_t90_services | services.count | ✓ |
| steps | sample_t180_health | cluster.health | ✓ |
| steps | sample_t180_services | services.count | ✓ |
| steps | sample_t270_health | cluster.health | ✓ |
| steps | sample_t270_services | services.count | ✓ |
| assertions | final_health | cluster.health | ✓ |
| assertions | final_service_count | services.count | ✓ |
...
```json
{
  ...
  "baseline_services": {
    ...
    "service_ids": [
      ...
      "613f9e54-723e-4716-9048-0f198471085d",
      ...
      "db640b86-439a-4ea7-a2a6-59cd33c2ce3e",
