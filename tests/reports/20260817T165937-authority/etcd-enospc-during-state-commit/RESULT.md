...
**Time**: 2026-08-17T17:03:37.602315Z  
**Checks**: 15 passed, 2 failed
...
| steps | exhaust_the_etcd_filesystem | chaos.fill_etcd_volume | ✗ |
| steps | attempt_mutation_while_full | ops.set_desired | ✓ |
| steps | release_the_space | chaos.clear_etcd_volume_fill | ✓ |
...
| cleanup | ensure_space_released | chaos.clear_etcd_volume_fill | ✓ |
