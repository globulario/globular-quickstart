...
**Result**: FAIL
**Date**: 2026-09-04 04:38:16 UTC
**Total**: 6 | **Pass**: 4 | **Fail**: 2 | **Skip**: 0

## Scenarios

- **[FAIL]** controller-zombie-after-lease-loss
- **[PASS]** crash-during-mutation-is-atomic
- **[PASS]** etcd-enospc-during-state-commit
- **[PASS]** full-blackout-thundering-herd
- **[PASS]** node-clone-identity-collision
