...
**Result**: FAIL
**Date**: 2026-09-04 10:09:58 UTC
**Total**: 12 | **Pass**: 9 | **Fail**: 3 | **Skip**: 0

## Scenarios

- **[FAIL]** deploy-publish-then-converge
...
- **[PASS]** platform-upgrade-release-boundary
- **[PASS]** published-artifact-is-installable-everywhere
- **[FAIL]** rejoin-with-stale-membership-state-is-bounded
