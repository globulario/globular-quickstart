...
**Time**: 2026-08-05T19:09:45.696398Z  
**Checks**: 12 passed, 4 failed
...
| restoration | auto-reconstruct-etcd | chaos.reconstruct_node_etcd_membership | ✗ |
| restoration | auto-reconstruct-etcd | chaos.reconstruct_node_etcd_membership | ✗ |
...
```json
{
  "_health_fingerprint": {
    ...
    "pki": {
      ...
      "node-3": "globular:globular/400 readable backups=0",
